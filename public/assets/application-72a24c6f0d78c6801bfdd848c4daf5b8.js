...
(function() {
  $(document).on("change", "#outfit_show", function() {
    var show_data;
    show_data = {
      show_id: $('#outfit_show').val()
    };
    return $.get("/shows/get_episodes.json", show_data, function(data) {
      ...
      return $.each(data, function(key, value) {
        ...
        return $.each(value, function(i, obj) {
          return $('#outfit_episode_id').append("<option value='" + obj.id + "'>" + obj.number + " - " + obj.name + "</option>");
        });
      });
    });
  });
  ...
  $(document).on("change", "#outfit_show", function() {
    ...
    return $.get("/shows/get_actors.json", show_data, function(data) {
      $('#actors').removeClass('hide');
      $('#outfit_actor_id').html('');
      return $.each(data, function(i, value) {
        return $('#outfit_actor_id').append("<option value='" + value.id + "'>" + value.name + " - " + value.role + "</option>");
      });
    });
  });
