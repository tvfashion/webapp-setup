...
class OutfitsControllerTest < ActionController::TestCase
  ...
  test "should create outfit" do
    assert_difference('Outfit.count') do
      post :create, outfit: { actor_id: @outfit.actor_id, episode_id: @outfit.episode_id, image: @outfit.image, name: @outfit.name }
    end
  ...
  test "should update outfit" do
    patch :update, id: @outfit, outfit: { actor_id: @outfit.actor_id, episode_id: @outfit.episode_id, image: @outfit.image, name: @outfit.name }
    assert_redirected_to outfit_path(assigns(:outfit))
  end
